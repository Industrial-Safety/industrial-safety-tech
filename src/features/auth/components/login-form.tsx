  ...
  return (
    <form onSubmit={handleSubmit} className="flex w-full max-w-sm flex-col gap-5 animate-in fade-in duration-300">
      ...
      <div className="grid grid-cols-4 gap-3">
        <Button type="button" variant="outline" onClick={() => loginWithProvider("google")}
        ...
        <Button type="button" variant="outline" onClick={() => loginWithProvider("facebook")}
        ...
        <Button type="button" variant="outline" onClick={() => loginWithProvider("twitter")}
        ...
        <Button type="button" variant="outline" onClick={() => loginWithProvider("github")}
