    ...
    <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500">
      ...
      <div>
        <h1 className="text-3xl font-bold tracking-tight mb-2">
          ¡Hola, {(session?.user?.name ?? "Trabajador").split(" ")[0]}!
        </h1>
                  ...
                  <div className="sm:w-2/5 p-4 relative">
                    <div className="aspect-video relative rounded-md overflow-hidden bg-slate-800 group-hover:scale-[1.02] transition-transform">
                      ...
                      {lastCourse.detail.coverImageUrl ? (
                        <img src={lastCourse.detail.coverImageUrl} alt={lastCourse.detail.title} className="w-full h-full object-cover" />
                      ) : (
                  ...
                  <div className="sm:w-3/5 p-6 flex flex-col justify-center">
                    ...
                    <div className="mt-auto space-y-2">
                      ...
                      <div className="h-1.5 w-full bg-surface-secondary rounded-full overflow-hidden">
                        <div className="h-full bg-primary rounded-full transition-all duration-1000" style={{ width: `${lastProgress}%` }} />
                      </div>
                    </div>
                    <div className="mt-6">
                      <Link href={`/trabajador/learning/${lastCourse.detail._id ?? lastCourse.detail.id ?? lastCourse.enrollment.courseId}`}>
            ...
            <Card className="bg-surface/40 border-border">
              <CardContent className="p-6">
                <div className="flex justify-between items-start">
                  ...
                  <div className="p-2 bg-success/10 rounded-lg"><BookOpen className="w-5 h-5 text-success" /></div>
                </div>
              </CardContent>
            </Card>
            <Card className="bg-surface/40 border-border">
              <CardContent className="p-6">
                <div className="flex justify-between items-start">
                  ...
                  <div className="p-2 bg-warning/10 rounded-lg"><Award className="w-5 h-5 text-warning" /></div>
                </div>
              </CardContent>
            </Card>
          </section>
          ...
          <div className="flex flex-col gap-4">
              ...
              <CardContent className="p-5">
                <div className="flex gap-3">
                  ...
                  <div>
                    ...
                    <Link href="/trabajador/learning" className="text-xs font-medium text-warning hover:underline flex items-center gap-1">
            ...
            <Card className="bg-danger/5 border-danger/20 relative overflow-hidden">
              ...
              <CardContent className="p-5 pl-6">
                <div className="flex gap-3">
                  <div className="shrink-0 mt-0.5"><AlertTriangle className="h-4 w-4 text-danger" /></div>
                  <div>
                    <h4 className="font-semibold text-sm text-danger tracking-wide">REQUERIDO URGENTE</h4>
                    <p className="text-sm mt-1 mb-3">Nuevo módulo obligatorio: <strong>Protocolo de Evacuación Sísmica</strong>.</p>
                    <Button variant="danger" size="sm" className="w-full text-xs h-8">Iniciar Módulo</Button>
                  </div>
                </div>
              </CardContent>
            </Card>
            <Card className="bg-surface/40 border-border">
              <CardContent className="p-5">
                <div className="flex gap-3">
                  <div className="shrink-0 mt-0.5"><div className="h-2 w-2 rounded-full bg-primary mt-1.5" /></div>
                  <div>
