...
export default function TrabajadorLayout({ children }: { children: React.ReactNode }) {
  ...
  const displayName = session?.user?.name || "Trabajador";
    ...
    <div className="flex h-screen w-full bg-background overflow-hidden font-sans text-foreground">
        ...
        <div className={cn(
          ...
          {!collapsed && (
            <div className="flex flex-col items-center animate-in fade-in duration-300">
              ...
              <Badge variant="outline" className="mt-1 text-[10px] text-primary border-primary/30 bg-primary/10 flex gap-1 items-center">
      ...
      <div className="flex flex-1 flex-col min-w-0 bg-background overflow-hidden relative">
        ...
        <div className="flex h-16 items-center justify-between border-b border-slate-800 bg-surface/50 backdrop-blur-md px-4 md:hidden">
          ...
          <span className="text-sm font-semibold text-foreground">Trabajador</span>
