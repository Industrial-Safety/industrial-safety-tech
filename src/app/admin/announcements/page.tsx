...
export default function AdminAnnouncementsPage() {
  ...
  const handleDelete = async (id: string) => {
    setDeleting(id);
    try {
      const res = await fetch(`/api/proxy/chat/announcements/${id}`, { method: "DELETE" });
    ...
    <div className="max-w-3xl mx-auto space-y-6 animate-in fade-in duration-500">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-muted text-sm mt-1">Comunicados para todo el staff — instructores, administradores y soporte</p>
        </div>
                ...
                <div className="flex-1 min-w-0">
                  <div className="flex items-start justify-between gap-2 mb-1">
                    ...
                    <Button
                      ...
                      className="h-7 w-7 text-muted hover:text-destructive shrink-0"
                  ...
                  {a.title && <h3 className="font-bold text-base mb-1">{a.title}</h3>}
